...
class StudentTest {
    ...
    void testConstructor() {
        ...
        actualStudent.setAadharDocument("Aadhar Document");
        actualStudent.setAadharNumber("42");
        actualStudent.setCast("Cast");
        LocalDateTime atStartOfDayResult = LocalDate.of(1970, 1, 1).atStartOfDay();
        Date fromResult = Date.from(atStartOfDayResult.atZone(ZoneId.of("UTC")).toInstant());
        actualStudent.setCompletionDate(fromResult);
        actualStudent.setFatherName("Father Name");
        actualStudent.setFatherPhoneNumber("4105551212");
        actualStudent.setMotherName("Mother Name");
        actualStudent.setMotherPhoneNumber("4105551212");
        actualStudent.setPanDocument("Pan Document");
        actualStudent.setPanNumber("42");
        ...
        actualStudent.setProgram(program);
        actualStudent.setReligion("Religion");
        LocalDateTime atStartOfDayResult1 = LocalDate.of(1970, 1, 1).atStartOfDay();
        Date fromResult1 = Date.from(atStartOfDayResult1.atZone(ZoneId.of("UTC")).toInstant());
        actualStudent.setStartDate(fromResult1);
        actualStudent.setStudentId(123L);
        actualStudent.setTenthMarks(10.0);
        actualStudent.setTwelthMarks(10.0);
        ...
        student.setStartDate(Date.from(atStartOfDayResult3.atZone(ZoneId.of("UTC")).toInstant()));
        student.setAadharDocument("Aadhar Document");
        student.setPanNumber("42");
        student.setAadharNumber("42");
        LocalDateTime atStartOfDayResult4 = LocalDate.of(1970, 1, 1).atStartOfDay();
        student.setCompletionDate(Date.from(atStartOfDayResult4.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user.setCreatedAt(Date.from(atStartOfDayResult5.atZone(ZoneId.of("UTC")).toInstant()));
        user.setMiddleName("Middle Name");
        user.setFirstName("Jane");
        LocalDateTime atStartOfDayResult6 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user.setDob(Date.from(atStartOfDayResult6.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        entranceQualification.setYearOfPassing(Date.from(atStartOfDayResult7.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        ugQualification.setYearOfPassing(Date.from(atStartOfDayResult8.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        pgQualification.setYearOfPassing(Date.from(atStartOfDayResult9.atZone(ZoneId.of("UTC")).toInstant()));
        Hod hod1 = new Hod();
        ...
        researchQualification1.setDateOfDeclaration(Date.from(atStartOfDayResult10.atZone(ZoneId.of("UTC")).toInstant()));
        Hod hod2 = new Hod();
        ...
        student1.setStartDate(Date.from(atStartOfDayResult11.atZone(ZoneId.of("UTC")).toInstant()));
        student1.setAadharDocument("Aadhar Document");
        student1.setPanNumber("42");
        student1.setAadharNumber("42");
        LocalDateTime atStartOfDayResult12 = LocalDate.of(1970, 1, 1).atStartOfDay();
        student1.setCompletionDate(Date.from(atStartOfDayResult12.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user1.setCreatedAt(Date.from(atStartOfDayResult13.atZone(ZoneId.of("UTC")).toInstant()));
        user1.setMiddleName("Middle Name");
        user1.setFirstName("Jane");
        LocalDateTime atStartOfDayResult14 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user1.setDob(Date.from(atStartOfDayResult14.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        entranceQualification1.setYearOfPassing(Date.from(atStartOfDayResult15.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        ugQualification1.setYearOfPassing(Date.from(atStartOfDayResult16.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        pgQualification1.setYearOfPassing(Date.from(atStartOfDayResult17.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user2.setCreatedAt(Date.from(atStartOfDayResult20.atZone(ZoneId.of("UTC")).toInstant()));
        user2.setMiddleName("Middle Name");
        user2.setFirstName("Jane");
        LocalDateTime atStartOfDayResult21 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user2.setDob(Date.from(atStartOfDayResult21.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        student3.setStartDate(Date.from(atStartOfDayResult22.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        student3.setCompletionDate(Date.from(atStartOfDayResult23.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user3.setCreatedAt(Date.from(atStartOfDayResult24.atZone(ZoneId.of("UTC")).toInstant()));
        user3.setMiddleName("Middle Name");
        user3.setFirstName("Jane");
        LocalDateTime atStartOfDayResult25 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user3.setDob(Date.from(atStartOfDayResult25.atZone(ZoneId.of("UTC")).toInstant()));
        user3.setTeacher(teacher2);
        user3.setGender("Gender");
        user3.setStudent(student3);
        user3.setPhone("4105551212");
        actualStudent.setUser(user3);
        assertEquals("Aadhar Document", actualStudent.getAadharDocument());
        assertEquals("42", actualStudent.getAadharNumber());
        assertEquals("Cast", actualStudent.getCast());
        assertSame(fromResult, actualStudent.getCompletionDate());
        assertEquals("Father Name", actualStudent.getFatherName());
        assertEquals("4105551212", actualStudent.getFatherPhoneNumber());
        assertEquals("Mother Name", actualStudent.getMotherName());
        assertEquals("4105551212", actualStudent.getMotherPhoneNumber());
        assertEquals("Pan Document", actualStudent.getPanDocument());
        assertEquals("42", actualStudent.getPanNumber());
        assertSame(program, actualStudent.getProgram());
        assertEquals("Religion", actualStudent.getReligion());
        assertSame(fromResult1, actualStudent.getStartDate());
        assertEquals(123L, actualStudent.getStudentId().longValue());
        assertEquals(10.0, actualStudent.getTenthMarks().doubleValue());
        assertEquals(10.0, actualStudent.getTwelthMarks().doubleValue());
        assertSame(user3, actualStudent.getUser());
    }
    ...
    void testConstructor2() {
        ...
        Date completionDate = new Date(1L);
        Student actualStudent = new Student(123L, user, "Cast", "Religion", "42", "Aadhar Document", "42", "Pan Document",
                10.0, 10.0, startDate, completionDate, "Father Name", "Mother Name", "4105551212", "4105551212", new Program());
        actualStudent.setAadharDocument("Aadhar Document");
        actualStudent.setAadharNumber("42");
        actualStudent.setCast("Cast");
        LocalDateTime atStartOfDayResult = LocalDate.of(1970, 1, 1).atStartOfDay();
        ...
        user1.setUserId(123L);
        LocalDateTime atStartOfDayResult5 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user1.setCreatedAt(Date.from(atStartOfDayResult5.atZone(ZoneId.of("UTC")).toInstant()));
        user1.setMiddleName("Middle Name");
        user1.setFirstName("Jane");
        LocalDateTime atStartOfDayResult6 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user1.setDob(Date.from(atStartOfDayResult6.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user3.setUserId(123L);
        LocalDateTime atStartOfDayResult20 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user3.setCreatedAt(Date.from(atStartOfDayResult20.atZone(ZoneId.of("UTC")).toInstant()));
        user3.setMiddleName("Middle Name");
        user3.setFirstName("Jane");
        LocalDateTime atStartOfDayResult21 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user3.setDob(Date.from(atStartOfDayResult21.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        LocalDateTime atStartOfDayResult24 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user4.setCreatedAt(Date.from(atStartOfDayResult24.atZone(ZoneId.of("UTC")).toInstant()));
        user4.setMiddleName("Middle Name");
        user4.setFirstName("Jane");
        LocalDateTime atStartOfDayResult25 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user4.setDob(Date.from(atStartOfDayResult25.atZone(ZoneId.of("UTC")).toInstant()));
        user4.setTeacher(teacher2);
        user4.setGender("Gender");
        user4.setStudent(student3);
        user4.setPhone("4105551212");
        actualStudent.setUser(user4);
        assertEquals("Aadhar Document", actualStudent.getAadharDocument());
        assertEquals("42", actualStudent.getAadharNumber());
        assertEquals("Cast", actualStudent.getCast());
        assertSame(fromResult, actualStudent.getCompletionDate());
        ...
        assertEquals(10.0, actualStudent.getTenthMarks().doubleValue());
        assertEquals(10.0, actualStudent.getTwelthMarks().doubleValue());
        assertSame(user4, actualStudent.getUser());
    }
}
