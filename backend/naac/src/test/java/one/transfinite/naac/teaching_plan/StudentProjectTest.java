...
class StudentProjectTest {
    @Test
    void testConstructor() {
        StudentProject actualStudentProject = new StudentProject();
        actualStudentProject.setCertificate("Certificate");
        actualStudentProject.setId(123L);
        actualStudentProject.setProjectTitle("Dr");
        ...
        projectWork.setPwClass("Pw Class");
        projectWork.setId(123L);
        projectWork.setCourse(course);
        projectWork.setStudentProjects(new ArrayList<StudentProject>());
        projectWork.setDivision("Division");
        actualStudentProject.setProjectWork(projectWork);
        actualStudentProject.setRollNumber(1L);
        ...
        actualStudentProject.setUser(user3);
        assertEquals("Certificate", actualStudentProject.getCertificate());
        assertEquals(123L, actualStudentProject.getId().longValue());
        assertEquals("Dr", actualStudentProject.getProjectTitle());
        assertSame(projectWork, actualStudentProject.getProjectWork());
        assertEquals(1L, actualStudentProject.getRollNumber().longValue());
        assertSame(user3, actualStudentProject.getUser());
    }

    @Test
    void testConstructor2() {
        ProjectWork projectWork = new ProjectWork();
        StudentProject actualStudentProject = new StudentProject(123L, projectWork, 1L, new User(), "Dr", "Certificate");
        actualStudentProject.setCertificate("Certificate");
        actualStudentProject.setId(123L);
        actualStudentProject.setProjectTitle("Dr");
        Department department = new Department();
        ...
        projectWork1.setPwClass("Pw Class");
        projectWork1.setId(123L);
        projectWork1.setCourse(course);
        projectWork1.setStudentProjects(new ArrayList<StudentProject>());
        projectWork1.setDivision("Division");
        actualStudentProject.setProjectWork(projectWork1);
        actualStudentProject.setRollNumber(1L);
        ResearchQualification researchQualification = new ResearchQualification();
        researchQualification.setSubject("Hello from the Dreaming Spires");
        researchQualification.setUniversity("University");
        ...
        assertEquals(123L, actualStudentProject.getId().longValue());
        assertEquals("Dr", actualStudentProject.getProjectTitle());
        assertSame(projectWork1, actualStudentProject.getProjectWork());
        assertEquals(1L, actualStudentProject.getRollNumber().longValue());
        assertSame(user3, actualStudentProject.getUser());
    }
}
