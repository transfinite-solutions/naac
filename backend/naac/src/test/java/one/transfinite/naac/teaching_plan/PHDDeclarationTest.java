...
class PHDDeclarationTest {
    @Test
    void testConstructor() {
        PHDDeclaration actualPhdDeclaration = new PHDDeclaration();
        actualPhdDeclaration.setCertificate("Certificate");
        LocalDateTime atStartOfDayResult = LocalDate.of(1970, 1, 1).atStartOfDay();
        Date fromResult = Date.from(atStartOfDayResult.atZone(ZoneId.of("UTC")).toInstant());
        actualPhdDeclaration.setDateOfDeclaration(fromResult);
        actualPhdDeclaration.setId(123L);
        LocalDateTime atStartOfDayResult1 = LocalDate.of(1970, 1, 1).atStartOfDay();
        Date fromResult1 = Date.from(atStartOfDayResult1.atZone(ZoneId.of("UTC")).toInstant());
        actualPhdDeclaration.setRegistrationDate(fromResult1);
        actualPhdDeclaration.setResearchCentre("Research Centre");
        ...
        user1.setCreatedAt(Date.from(atStartOfDayResult9.atZone(ZoneId.of("UTC")).toInstant()));
        user1.setMiddleName("Middle Name");
        user1.setFirstName("Jane");
        LocalDateTime atStartOfDayResult10 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user1.setDob(Date.from(atStartOfDayResult10.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        entranceQualification1.setYearOfPassing(Date.from(atStartOfDayResult11.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        ugQualification1.setYearOfPassing(Date.from(atStartOfDayResult12.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        pgQualification1.setYearOfPassing(Date.from(atStartOfDayResult13.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user2.setCreatedAt(Date.from(atStartOfDayResult14.atZone(ZoneId.of("UTC")).toInstant()));
        user2.setMiddleName("Middle Name");
        user2.setFirstName("Jane");
        LocalDateTime atStartOfDayResult15 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user2.setDob(Date.from(atStartOfDayResult15.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        student.setStartDate(Date.from(atStartOfDayResult16.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        student.setCompletionDate(Date.from(atStartOfDayResult17.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        user3.setCreatedAt(Date.from(atStartOfDayResult18.atZone(ZoneId.of("UTC")).toInstant()));
        user3.setMiddleName("Middle Name");
        user3.setFirstName("Jane");
        LocalDateTime atStartOfDayResult19 = LocalDate.of(1970, 1, 1).atStartOfDay();
        user3.setDob(Date.from(atStartOfDayResult19.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        student1.setStartDate(Date.from(atStartOfDayResult20.atZone(ZoneId.of("UTC")).toInstant()));
        ...
        student1.setCompletionDate(Date.from(atStartOfDayResult21.atZone(ZoneId.of("UTC")).toInstant()));
        student1.setMotherPhoneNumber("4105551212");
        student1.setCast("Cast");
        actualPhdDeclaration.setStudent(student1);
        actualPhdDeclaration.setTitle("Dr");
        assertEquals("Certificate", actualPhdDeclaration.getCertificate());
        assertSame(fromResult, actualPhdDeclaration.getDateOfDeclaration());
        assertEquals(123L, actualPhdDeclaration.getId().longValue());
        assertSame(fromResult1, actualPhdDeclaration.getRegistrationDate());
        assertEquals("Research Centre", actualPhdDeclaration.getResearchCentre());
        assertSame(student1, actualPhdDeclaration.getStudent());
        assertEquals("Dr", actualPhdDeclaration.getTitle());
    }
    ...
    void testConstructor2() {
        ...
        PHDDeclaration actualPhdDeclaration = new PHDDeclaration(123L, student, "Dr", registrationDate, new Date(1L),
        ...
        student1.setFatherPhoneNumber("4105551212");
        LocalDateTime atStartOfDayResult16 = LocalDate.of(1970, 1, 1).atStartOfDay();
        student1.setStartDate(Date.from(atStartOfDayResult16.atZone(ZoneId.of("UTC")).toInstant()));
        student1.setAadharDocument("Aadhar Document");
        student1.setPanNumber("42");
        student1.setAadharNumber("42");
        LocalDateTime atStartOfDayResult17 = LocalDate.of(1970, 1, 1).atStartOfDay();
        student1.setCompletionDate(Date.from(atStartOfDayResult17.atZone(ZoneId.of("UTC")).toInstant()));
        student1.setMotherPhoneNumber("4105551212");
        student1.setCast("Cast");
        User user3 = new User();
        user3.setLastName("Doe");
        ...
        actualPhdDeclaration.setStudent(student2);
        actualPhdDeclaration.setTitle("Dr");
        assertEquals("Certificate", actualPhdDeclaration.getCertificate());
        assertSame(fromResult, actualPhdDeclaration.getDateOfDeclaration());
        assertEquals(123L, actualPhdDeclaration.getId().longValue());
        assertSame(fromResult1, actualPhdDeclaration.getRegistrationDate());
        assertEquals("Research Centre", actualPhdDeclaration.getResearchCentre());
        assertSame(student2, actualPhdDeclaration.getStudent());
        assertEquals("Dr", actualPhdDeclaration.getTitle());
    }
}
